...
public class ChessMatch {
	...
	private void undoMovement(Position source, Position target, Piece capturedPiece) {
	...
	private boolean testCheck(Color color) {
		...
		List<Piece> oponentPieces = piecesOnTheBoard.stream().filter(x -> ((ChessPiece)x).getColor() == oponent(color)).collect(Collectors.toList());
